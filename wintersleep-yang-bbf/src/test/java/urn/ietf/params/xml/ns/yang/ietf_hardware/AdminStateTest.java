 ...
 * #L%
 */
package urn.ietf.params.xml.ns.yang.ietf_hardware;
...
public class AdminStateTest {
    ...
    private static void assertEnum(String expectedName, String expectedYangName, int expectedYangValue, YangEnum enumConstant) {
        assertEquals(expectedName, enumConstant.getName());
